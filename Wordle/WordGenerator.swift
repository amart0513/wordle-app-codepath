...
class WordGenerator {
  ...
  static let possibleWords = ["AUDIO", "RANGE", "OCEAN", "SMILE", "DANCE", "SALSA"]
    
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE
      
    // Use the randomElement() to select a random word from possibleWords
    let randomString = possibleWords.randomElement()

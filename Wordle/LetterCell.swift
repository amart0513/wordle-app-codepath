...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    ...
    // ...
      ...
      switch style {
      case .initial:
          // Set the background color to black and border to gray
          contentView.backgroundColor = UIColor.black
          layer.borderColor = UIColor.gray.cgColor
      case .incorrect:
          // Set the background color and border color if the letters and position are incorrect
      ...
      case .correctLetterOnly:
          // Set the background and border color if the letters are correct only
      ...
      case .correctLetterAndPosition:
          // Set the background and border color if both letters and positions are correct
